...
- **Recibo de Abono a Capital en PDF**, generado automaticamente al registrar un abono (desde Cartera, desde el perfil del deudor o al liquidar): confirma el monto recibido y el nuevo saldo, e incluye el cronograma de pagos actualizado con el impacto del abono (cuanto bajo la cuota, cuantas cuotas menos quedan o la nueva cuota fija, segun como recalcules). Si el abono salda el prestamo, el documento se convierte en un Paz y Salvo
